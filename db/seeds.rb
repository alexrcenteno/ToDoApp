...
user1 = User.create!(name: "Nick", email: "nick@email.com", password: "password")
user2 = User.create!(name: "Annie", email: "annie@email.com", password: "password")
user3 = User.create!(name: "Dallin", email: "dallin@email.com", password: "password")
user4 = User.create!(name: "Alex", email: "alex@email.com", password: "password")
